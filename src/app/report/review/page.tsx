...
export default function ReviewPage() {
  ...
  return (
    <div>
      <h1 className="text-h1 text-deep-navy">Review your complaint</h1>
      ...
      <div className="mt-10 flex items-center justify-between">
        ...
        <Button type="button" onClick={submit} disabled={!data.email.trim()}>
          Submit complaint
        </Button>
      </div>
    </div>
